...
void send_wifi_html()
{
  ...
  html.replace( "@ip_3",  (String) config.IP[3] );
  html.replace( "@nm_0",  (String) config.Netmask[0] );
  html.replace( "@nm_1",  (String) config.Netmask[1] );
  html.replace( "@nm_2",  (String) config.Netmask[2] );
  html.replace( "@nm_3",  (String) config.Netmask[3] );
  html.replace( "@gw_0",  (String) config.Gateway[0] );
  html.replace( "@gw_1",  (String) config.Gateway[1] );
  html.replace( "@gw_2",  (String) config.Gateway[2] );
  html.replace( "@gw_3",  (String) config.Gateway[3] );
